...
$stmt1 ='SELECT * FROM products WHERE category="Women"';
$result = mysqli_query($conn,$stmt1);
$women_collection = $result -> fetch_all(MYSQLI_ASSOC);

template_header('women_collection');
?>


<section>
<div class="womencoll content-wrapper-women">

    <h2 class="product-category">WOMEN COLLECTIONS</h2>
            
            
            <div class="product-container-kids">
            <?php foreach ($women_collection as $product2): ?>
